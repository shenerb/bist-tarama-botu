...
if use_volume:
    volume_threshold = st.sidebar.slider("Hacim Artış Eşiği (kat)", 0.0, 5.0, 1.0)
else:
    volume_threshold = 0.0  # Etki etmeyecek
...
if st.button("🔍 Taramayı Başlat"):
    with st.spinner("Hisseler taranıyor..."):
        ...
        df = scan_stocks(
            all_tickers, ma_tolerance,
            volume_threshold, use_ma,
            use_volume, use_rsi, rsi_threshold, ceiling_threshold
        )
