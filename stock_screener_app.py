...
# 📘 Yardım Sekmesi
with st.expander("📘 Yardım / Uygulama Rehberi", expanded=False):
    st.markdown("""
### 🛠️ Filtre Parametreleri Açıklamaları

**MA Yakınlık Toleransı (%):**
- Hisse fiyatının hareketli ortalamalara (MA20, MA50, MA200) ne kadar yakın olacağını belirler.
- Örneğin: %5 seçerseniz, fiyat bu ortalamaların %5 altına kadar olan hisseler dahil edilir.

**Hacim Artış Eşiği (kat):**
- Hacmin son 20 günlük ortalamasına göre kaç kat arttığını belirler.
- Örneğin: 1.5 seçerseniz, güncel hacmi 20 günlük ortalamanın 1.5 katından fazla olan hisseler filtrelenir.

**RSI Dip Filtresi:**
- RSI (Relative Strength Index) değeri belirtilen eşiğin altında olan hisseler dahil edilir.
- Genellikle RSI < 30 dip sinyali olarak değerlendirilir.

**Bugün Tavan Yapanlar:**
- %9.5 veya üzeri yükselen hisseleri filtrelemek için kullanılır.

**Seçili Hisseler:**
- Belirli hisseleri seçebilir veya boş bırakarak tüm BIST hisselerini tarayabilirsiniz.

---

💡 Bu uygulama, teknik analiz tabanlı tarama yapar. Temel analiz kararlarınızı desteklemek amacıyla kullanılmalıdır.
""")
