...
Filtreleri ayarlayıp, hisse listesinden seçim yaparak "Taramayı Başlat" butonuna basınız.
""")
...
if st.button("🔍 Taramayı Başlat"):
    with st.spinner("Hisseler taranıyor..."):
        ...
        df = scan_stocks(
            ...
            use_ma, use_volume, use_rsi, rsi_threshold,
            ceiling_threshold, use_pddd_filter
        )
