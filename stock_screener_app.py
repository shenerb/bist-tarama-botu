...
# MACD ve RSI kesişimlerine göre işlem sinyali üretimi (güncellendi)
def generate_trade_signal(rsi_last, macd_last, macd_prev, signal_last, signal_prev, close, ema):
    ...
    if rsi_oversold and macd_cross_up and price_above_ema:
        return "AL"
    elif rsi_overbought and macd_cross_down and price_below_ema:
        return "SAT"
    else:
        return "NÖTR"
